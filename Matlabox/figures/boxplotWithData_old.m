...
[ax,x,g,notch,symbol,orientation,whisker,labels,labelverbosity, ...
    ...
    factordirection,linewidth,datamarkersize] ...
    = parseArgs(varargin);
...
%%%
drawDataPoints(axhg, gPos, groupIndexByPoint, xDat, jitter, datamarkersize);
...
[hdata,houtliers] = renderBoxes(axhg,gPos,maxGuaranteedGap,orientation,...
    ...
    notch,medianstyle,boxstyle,gWidth,outliersize,linewidth);
...
function [ax,x,g,notch,symbol,orientation,whisker,labels,labelverbosity,...
    ...
    fullfactors,factorgap,factorseparator, extrememode,datalim,...
    jitter,medianstyle,boxstyle,outliersize,labelorientation,...
    factordirection,linewidth,datamarkersize] = parseArgs(inargs)
...
okargs =   {'notch' 'symbol' 'orientation' 'whisker' 'labels' ...
    ...
    'factordirection' 'color' 'label' 'linewidth' 'datamarkersize'};
    ...
    case 'outline',
        ...
        hwhisker = ...
            ...
            'lineAlongResponse',{...
                ...
                'locationend',boxValPlot.whi,...
                'linestyle','--','linewidth',linewidth,'linecolor',cWhisker,...
                'tag','Upper Whisker'},...
            'lineAlongResponse',{...
                'locationstart',boxValPlot.wlo,...
            ...
            case 'on',
                hbox = ...
                    ...
                    'lineBoxNotched',{...
                        ...
                        'linestyle','-','linewidth',linewidth,'linecolor',cBox,...
                        'tag','Box'}...
                    );
            case {'off','marker'}
                hbox = ...
    ...
    case 'line',
        hmedian = ...
            ...
            'lineAlongFactor',{'location',boxValPlot.q2,...
                ...
                'linestyle','-','linewidth',linewidth,'linecolor',cMedian,...
                'tag','Median'}...
            );
    otherwise
        error(message('stats:boxplot:BadMedianStyle'));
...
%         'tag','Outliers'}...
%     );
houtliers = NaN(1, length(hmedian));
