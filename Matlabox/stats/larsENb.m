function [larsenmodel] = larsENb(X, y, lambda2, stop, trace, maxstepnum, datanorm)
...
% Hui Zou and Trevor Hastie, 2005.
    ...
    if datanorm
        ...
        larsenmodel.meanx = mean(X);
        larsenmodel.ybar = mean(y);
        larsenmodel.normx = zeros(size(X,2),1);
