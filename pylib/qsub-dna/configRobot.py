...
#For each line in a 'set', the format is <parameter> <tab> <values>; values can be empty string if the paramter is a switch (taking no values), if multiple values are provided, they should be separated by ';'
#
