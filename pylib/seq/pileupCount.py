...
argp.add_argument('-r',  metavar='INT', type=int, default=1, help='min reads required for each base')
...
argp.add_argument('-samtools', type=str, default='/nfs/sw/samtools/samtools-1.1/samtools', help='samtools path, [/nfs/sw/samtools/samtools-1.1/samtools]')
